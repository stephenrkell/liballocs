...
fun(liballocs_err_t    ,set_type,      arg(void *, obj), arg(struct uniqtype *,new_t)) /* optional (stack) */\
fun(liballocs_err_t    ,set_site,      arg(void *, obj), arg(struct uniqtype *,new_t)) /* optional (stack) */
